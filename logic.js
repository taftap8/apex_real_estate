...
function hometype() {
    ...
    select.innerHTML = ""; 
    homeinput = d3.select("#hometype").property("value")
    if (homeinput == "home") {
        elmts = hsubdivisions ;
    } 
    
    else if (homeinput == "townhouse"){
        elmts = tsubdivisions;
    } 
...
function prediction() {
    ...
    if(inputtype == "home") {
        ...
        return Swal.fire({
            ...
            imageUrl: "https://media.giphy.com/media/MAcZH4WmbFgQdPuVQX/giphy.gif",
            // imageWidth: 600,
            // imageHeight: 600,
    ...
    else if (inputtype == "townhouse")
    {
        console.log(inputhomeyear)
        d3.request("http://127.0.0.1:5000/predict1/" + inputhomeyear + "/" + inputhomebedrooms + "/" + inputhomebath +"/" + inputhomearea + "/" + inputhomehalfbath +"/" + inputhomegarage +"/" + inputhomesubdivision).get(response => {
        console.log(response.response)    
        
        //calling the alert
        return Swal.fire({
            title: `Your Townhome is worth $${response.response}!`,
            text: 'Click to make another prediction',
            imageUrl: "https://media.giphy.com/media/MAcZH4WmbFgQdPuVQX/giphy.gif",
            // imageWidth: 600,
            // imageHeight: 600,
