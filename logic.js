...
var tableData;
	$.ajax({
	  type: "GET",  
	  url: "detachedLATLNG.csv",
	  dataType: "text",       
	  success: function(response)  
	  {
		tableData = $.csv.toObjects(response);
...
tableData.forEach(function (apexdata) {
    console.log(apexdata);
    var row = tbody.append("tr");
    Object.entries(apexdata).forEach(function ([key, value]) {
...
//     .tableData]; //to make each filter independent of each other
//   if (datevalue) {
